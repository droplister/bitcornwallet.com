  ...
  <div>
    ...
    <b-modal id="createWallet" title="Create New Wallet" cancel-variant="outline-secondary" ok-variant="outline-success" no-close-on-backdrop no-close-on-esc ok-only centered>
      ...
      <div class="alert alert-warning py-2 px-2 mb-1">
        <small>
          These 12 words are your passphrase. You can think of them as the password to your blockchain bank account. If you lose this passphrase, you will lose access to your entire account and its funds. Keep it secret. Keep it safe!
        </small>
      </div>
    </b-modal>
  </div>
